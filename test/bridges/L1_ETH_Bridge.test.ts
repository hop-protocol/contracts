...
describe('L1_ETH_Bridge', () => {
  ...
  before(async () => {
    ...
    let fixtureOpts: any = {
      l2CanonicalTokenIsEth: true
    }
    _fixture = await fixture(l1ChainId, l2ChainId, fixtureOpts)
  ...
  describe('constructor', async () => {
    ...
    it('Should set the bonder address in the constructor', async () => {
