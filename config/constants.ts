...
export const MAX_APPROVAL: BigNumber = BigNumber.from('0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff')
export const ARB_CHAIN_ADDRESS: string = '0x2e8aF9f74046D3E55202Fcfb893348316B142230'
...
export const LIQUIDITY_PROVIDER_INITIAL_BALANCE: BigNumber = BigNumber.from(parseEther('1000'))
export const LIQUIDITY_PROVIDER_UNISWAP_AMOUNT: BigNumber = LIQUIDITY_PROVIDER_INITIAL_BALANCE.div(2)
