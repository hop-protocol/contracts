...
const getOptimismContractFactories = async (signer: Signer, ethers: any, ovmEthers: any) => {
  ...
  const L1_MessengerWrapper: ContractFactory = await ethers.getContractFactory('contracts/wrappers/OptimismMessengerWrapper.sol:OptimismMessengerWrapper', { signer })
  ...
  const L2_UniswapFactory: ContractFactory = await ovmEthers.getContractFactory('contracts/uniswap/optimism/OptimismUniswapFactory.sol:OptimismUniswapFactory', { signer })
  const L2_UniswapRouter: ContractFactory = await ovmEthers.getContractFactory('contracts/uniswap/optimism/OptimismUniswapRouter.sol:OptimismUniswapRouter', { signer })
  const L2_UniswapPair: ContractFactory = await ovmEthers.getContractFactory('contracts/uniswap/optimism/OptimismUniswapPair.sol:OptimismUniswapPair', { signer })
...
const getArbitrumContractFactories = async (signer: Signer, ethers: any) => {
  ...
  const L1_MessengerWrapper: ContractFactory = await ethers.getContractFactory('contracts/wrappers/ArbitrumMessengerWrapper.sol:ArbitrumMessengerWrapper', { signer })
  ...
  const L2_UniswapFactory: ContractFactory = await ethers.getContractFactory('contracts/uniswap/arbitrum/ArbitrumUniswapFactory.sol:ArbitrumUniswapFactory', { signer })
  const L2_UniswapRouter: ContractFactory = await ethers.getContractFactory('contracts/uniswap/arbitrum/ArbitrumUniswapRouter.sol:ArbitrumUniswapRouter', { signer })
